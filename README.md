...
[![Test and Build](https://github.com/crisp-im/crisp-status-local/actions/workflows/test.yml/badge.svg)](https://github.com/crisp-im/crisp-status-local/actions/workflows/test.yml) [![Build and Release](https://github.com/crisp-im/crisp-status-local/actions/workflows/build.yml/badge.svg)](https://github.com/crisp-im/crisp-status-local/actions/workflows/build.yml) [![dependency status](https://deps.rs/repo/github/crisp-im/crisp-status-local/status.svg)](https://deps.rs/repo/github/crisp-im/crisp-status-local)
